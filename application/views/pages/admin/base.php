...
<head>
  ...
  <!-- AdminLTE Skins. Choose a skin from the css/skins
  	...
  	<!-- Morris chart -->
  	<link rel="stylesheet" href="<?php echo base_url('assets/admin_assets/bower_components/morris.js/morris.css') ?>">
  	<!-- jvectormap -->
  	<link rel="stylesheet" href="<?php echo base_url('assets/admin_assets/bower_components/jvectormap/jquery-jvectormap.css') ?>">
  	<!-- Date Picker -->
  	<link rel="stylesheet" href="<?php echo base_url('assets/admin_assets/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css') ?>">
  	<!-- Daterange picker -->
