...
<!-- Mirrored from crenoveative.com/envato/edutute/instructor-grid-02.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 28 Apr 2019 19:36:14 GMT -->
<head>
											...
											<div class="row">
												...
												<div class="col-xss-3 col-xs-3 col-sm-3">
													<div class="sort-by-wrapper for-layout-option">
														...
														<div class="sorting-middle-holder">
															<a href="instructor-list.html" class="btn btn-sorting active"><i class="fa fa-th-list"></i></a>
															<a href="instructor-grid.html" class="btn btn-sorting"><i class="fa fa-th-large"></i></a>
														</div>
													</div>
												</div>
