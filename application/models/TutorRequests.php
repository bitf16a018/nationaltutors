...
class TutorRequests extends CI_Model {
	...
	{
		$this->db->select('tutor.name,tutor.email, tutor_requests.tutor_id, tutor_requests.status as request_status, date(tutor_requests.date_of_request) date_of_request, tutor_requests.date_of_response');
